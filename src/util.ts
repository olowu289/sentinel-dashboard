...
const FRIENDLY: Record<string, string> = {
  ...
  hub_webrtc_misconfigured: 'Control plane is missing WebRTC proxy credentials',
  hub_webrtc_unreachable: 'Cannot reach hub WebRTC service (tower may still be online)',
  hub_webrtc_timeout: 'Hub WebRTC service timed out waiting for the tower',
